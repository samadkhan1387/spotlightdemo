...
class Medication2Page extends StatefulWidget {
  const Medication2Page({super.key});

  @override
  _Medication2PageState createState() => _Medication2PageState();
}

class _Medication2PageState extends State<Medication2Page> {
